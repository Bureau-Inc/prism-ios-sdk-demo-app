...
#ifndef PRISM_IOS_NATIVE_SDK_SWIFT_H
#define PRISM_IOS_NATIVE_SDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="prism_ios_native_sdk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC20prism_ios_native_sdk8Gradient")
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk15IQBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk28IQBarButtonItemConfiguration") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk12IQInvocation") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk17IQKeyboardManager") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
@interface IQKeyboardManager (SWIFT_EXTENSION(prism_ios_native_sdk)) <UIGestureRecognizerDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardManager (SWIFT_EXTENSION(prism_ios_native_sdk))
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk26IQKeyboardReturnKeyHandler") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(prism_ios_native_sdk)) <UITextFieldDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface IQKeyboardReturnKeyHandler (SWIFT_EXTENSION(prism_ios_native_sdk)) <UITextViewDelegate>
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk18IQPreviousNextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk10IQTextView") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk20IQTitleBarButtonItem") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk9IQToolbar") SWIFT_AVAILABILITY(ios_app_extension,unavailable)
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk15PrismEntryPoint")
@interface PrismEntryPoint : UIViewController
...
@interface PrismEntryPoint (SWIFT_EXTENSION(prism_ios_native_sdk)) <UIAdaptivePresentationControllerDelegate>
...
SWIFT_CLASS("_TtC20prism_ios_native_sdk15SessionDelegate")
...
@interface SessionDelegate (SWIFT_EXTENSION(prism_ios_native_sdk)) <NSURLSessionDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(prism_ios_native_sdk)) <NSURLSessionDataDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(prism_ios_native_sdk)) <NSURLSessionDownloadDelegate>
...
@interface SessionDelegate (SWIFT_EXTENSION(prism_ios_native_sdk)) <NSURLSessionTaskDelegate>
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIImage (SWIFT_EXTENSION(prism_ios_native_sdk))
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIScrollView (SWIFT_EXTENSION(prism_ios_native_sdk))
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIView (SWIFT_EXTENSION(prism_ios_native_sdk))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
@property (nonatomic) CGFloat keyboardDistanceFromTextField;
...
SWIFT_AVAILABILITY(ios_app_extension,unavailable)
@interface UIViewController (SWIFT_EXTENSION(prism_ios_native_sdk))
